export const thoughts = [
  {
    ...
    text:
      'Brian Holt\'s famous <a href="https://twitter.com/holtbt/status/977419276251430912" target="_blank">fullstack developer horse</a> is the perfect depiction of a sad reality. A lot of really great code will never see the light of day because it is completely inaccessible to the target audience. I\'ve taken the inverse approach and worked my way top down through the typical web application stack in competency.',
    quote:
  ...
  },
  {
    ...
    text:
      "A line of code might be read thousands of times and written once. Make it work, make it right, make it fast is a mantra we learn early. I would add make it intuitive or maintainable after make it right. Code complexity is often excused as elegant, because the solution relies on some nuance of the language. For historic and often no longer relevant reasons a one-liner is seen as more elegant than a three-line implementation even if the rest of your team needs to consult the author or Stack Overflow to understand it. Simplicity without sacrificing performance is elegant, not brevity for brevity's sake. When complexity is unavoidable, do everyone (especially yourself) a favor and add comments.",
    quote:
  ...
  },
  {
    ...
    text:
      "Spending a few hours at a whiteboard can save you a few days at a keyboard. This is the coder version of the old adage measure twice, cut once. The thing I really love about whiteboards is their ephemeral nature. People who spend days on a PowerPoint presentation or writing a proposal often become defensive of their ideas simply because of the time they've already invested in their presentation. The same is true of code, once written. Inherent in whiteboard discussions is the idea that we can erase everything and start over as needed.",
    quote:
  ...
  },
  {
    title: 'On learning',
    text:
      "Remaining a professional in any profession requires some degree of continuing education, but the rate of change in software engineering makes it impossible to rest on your laurels even for a few months. At the beginning of 2018, I considered myself an expert in Angular development, and now the most I would say is that I'm familiar with it and could probably pick it up again quickly. This is an acknowledgement on my part that two years spent away from any evolving technology is enough to make it unrecognizable upon your return.<br/><br/>Whenever possible, I take advantage of free or low cost options for keeping up with the times. In trying to gauge a candidate for an open position I was always more interested in how willing and able someone was to learn something new rather than what they already knew.",
    quote:
  ...
  },
  {
    title: 'On scope',
    text:
      'If you\'re equally good at everything you are likely exceptional at nothing. We\'re taught early on to refactor functions when they become too large, but often fail to be a voice against scope creep in other aspects of software development. I learned this lesson the hard way during my time at the startup I co-founded. I take the lesson from <a href="https://leanstartup.co/team/eric-ries/" target="_blank">Eric Ries</a> to heart: assumptions should be challenged to whatever degree possible before investing time and and energy into implementation.<br /><br />Go and Redis stand out to me as two technologies that are successful because they each focus on solving specific problems. Specialization is good thing. I would much rather have a garage full of individual tools than a garage full of Swiss army knives.',
    quote:
  ...
  },
  {
    title: 'On ethics',
    text:
      'I am concerned by the goto Silicon Valley defense, "we\'re a technology company." In <span style="text-decoration: underline">Ready Player One</span> and <span style="text-decoration: underline">Ready Player Two</span>, Ernest Cline makes a case for social media, not WMD, being the <a href="https://en.wikipedia.org/wiki/Great_Filter" target="_blank">Great Filter</a> that prevents intelligent life from progressing beyond a certain point and I am inclined to agree. We should consider the consequences of <a href="https://www.theguardian.com/technology/2018/feb/02/how-youtubes-algorithm-distorts-truth" target="_blank">what we build</a> and take responsibility for the consequences.',
    quote:
...
export const comments = [
  ...
  // [
  //   "my favorite cuisine is tagine, a dish named for the pottery it's cooked in",
  ...
  //   "sometimes i think i'm pretty good and then some random old man reminds me that i'm not",
  //   'one of my retirement goals is to become that old man',
  // ],
  // [
  //   'we spend most of our disposable income on travel',
  //   'and generally prefer the views you get from a mountain top rather than a four-star hotel',
  ...
  // ],
  // [
  //   'a cup of coffee, the dog, and the Sunday paper on our porch swing is a weekly ritual',
  //   'i try and alternate between fiction and non-fiction',
...
export const projects = [
  ...
  { name: 'VueRx Presentation', title: 'vuerx', path: '' },
