export const thoughts = [
  ...
  },
  {
    title: 'On learning',
    text:
      "Remaining a professional in any profession requires some degree of continuing education, but the rate of change in software engineering makes it impossible to rest on your laurels even for a few months. At the beginning of 2018, I considered myself an expert in Angular development, and now the most I would say is that I'm familiar with it and could probably pick it up again quickly. This is an acknowledgement on my part that two years spent away from any evolving technology is enough to make it unrecognizable upon your return.<br/><br/>Whenever possible, I take advantage of free or low cost options for keeping up with the times. When considering a candidate for one of our open positions, I was always more interested in how willing and able someone was to learn something new rather than what they already knew.",
    quote:
  ...
  },
  {
    title: 'On ethics',
    text:
      'I am concerned by the goto Silicon Valley defense, "we\'re a technology company." In <span style="text-decoration: underline">Ready Player One</span> and <span style="text-decoration: underline">Ready Player Two</span>, Ernest Cline makes a case for social media, not WMD, being the <a href="https://en.wikipedia.org/wiki/Great_Filter" target="_blank">Great Filter</a> that prevents intelligent life from progressing beyond a certain point and I am inclined to agree. We should consider the consequences of <a href="https://www.theguardian.com/technology/2018/feb/02/how-youtubes-algorithm-distorts-truth" target="_blank">what we build</a> and wield the double-edged sword of progress more responsibly.',
    quote:
